...
def main():
    ...
    env = simple_spread_v3.parallel_env(
        N=args.n_agents, max_cycles=args.max_cycles, continuous_actions=True
    )
    ...
    if history:
        ...
        plot_returns(history, f'results/spread_returns_{args.exp_id}')
    else:
